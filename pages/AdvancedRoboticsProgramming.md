...
* **[Pneumatic Actuator](https://trc492.github.io/pages/PneumaticActuator.html)**: Pnuematic Actuators are only legal for FRC but not FTC. The Framework Library provides extended support of pneumatics in the **FrcPneumatic** class. It supports one or two channel pneumatic cylinders and provides methods to extend/retract the cylinders with optional delay and duration.
